...
![image](/Consolidated_new/Screenshots/Screenshot%2012.png)
    ...
    Based on the scatter plot, there is a positive correlation between bedroom rent prices and the population of each county. A county with higher population might have higher rent prices.
...
![image]/(/Consolidated_new/Screenshots/Screenshot%2013.png)
    ...
    Based on the map, the top 5 counties with the highest population are Cobb, Fulton, DeKalb, Gwinnett and Taliaferro counties. The counties with the least population are Glascock, Chatham, Quitman, Webster and Clay counties. With the exception of Savannah, it looks like the most populated counties are the ones closest to the city of Atlanta. We know that there is a positive correlation between population and rent price. Is there also a correlation between distance from the center of Atlanta and rent price?
